...
const expressions = {
    ...
    allergies: /^[a-zA-ZÀ-ÿ\s]{2,40}$/, // Letras, con espacios, mínimo 2 y máximo 40 (incluye hasta 4 espacios).
};
...
$('.form__input').on('keyup blur', function (e) {
    switch (e.target.name) {
        case "nameKids":
            ...
            break;
        case "surnameKids":
            validateField(expressions.name, e.target, 'surnameKids');
            break;
        case "age":
        ...
        case "phone":
            ...
            break;
        case "allergiesKids":
            validateField(expressions.name, e.target, 'allergiesKids');
            break;
    }
});

// Validar campo de selección en el formulario de agregar
$('#select-diet').on('change', function () {
    validateSelect($(this), '#group__diet');
  });
